...
As such, it requires *Gradle 5.1.1 or later*. If you are using an earlier version of Gradle, please refer to the
...
plugins {
    id 'org.unbroken-dome.test-sets' version '2.3.0-adnovum'
}
